...
namespace ShoesData
{
    ...
    public partial class DataProductsEntities : DbContext
    {
        ...
        public virtual ObjectResult<SearchByIdOrName_Result> SearchByIdOrName(Nullable<int> id, string nombre)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchByIdOrName_Result>("SearchByIdOrName", idParameter, nombreParameter);
        }
